...
__device__ inline bool intersect_voxel(glm::vec3 origin, const glm::vec3 direction, glm::vec3& normal, float& distance, Scene::GPUScene scene, glm::ivec3 camera_position) {
	float tminn;
