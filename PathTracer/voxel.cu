...
////}
//
//__device__ bool intersect_brick_simple(glm::vec3 origin, glm::vec3 direction, Brick* brick) {
//	origin = glm::mod(origin, 8.f);
//	glm::ivec3 pos = origin;
//	glm::ivec3 out;
//	glm::ivec3 step;
...
//}
//
//__device__ bool intersect_voxel(glm::vec3 origin, glm::vec3 direction, glm::vec3& normal, float& distance, Scene::GPUScene scene) {
//	float tminn;
...
//			}
//
//			if (intersect_brick(origin * 8.f + direction * (new_distance * 8.f + epsilon), direction, normal, sub_distance, &scene.bricks[index & 0x7FFFFFFFu])) {
...
//			// request
//
//			//const unsigned int index = atomicAdd(&scene.brick_load_queue_size, 1);
//			//scene.brick_load_queue[index] = pos;
//
...
//}
//
//__device__ bool intersect_voxel_simple(glm::vec3 origin, glm::vec3 direction, Scene::GPUScene scene) {
...
//		if (index & brick_loaded_bit) {
//			if (intersect_brick_simple(origin * 8.f + direction * (distance * 8.f + epsilon), direction, &scene.bricks[index & 0x7FFFFFFFu])) {
//				return true;
//			}
//		} else if (index & brick_unloaded_bit) {
//			// load?
