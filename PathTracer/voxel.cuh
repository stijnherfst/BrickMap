...
//__device__ inline bool intersect_byte_simple(glm::vec3 origin, glm::vec3 direction, uint8_t byte) {
//	glm::ivec3 pos = origin;
//
//	glm::ivec3 out;
//	glm::ivec3 step;
...
//__device__ inline bool intersect_voxel_simple(glm::vec3 origin, glm::vec3 direction, Scene::GPUScene scene, glm::ivec3 camera_position) {
...
//				return true;
//			} else if (lod_distance_squared > lod_distance_2x2x2) {
//				if (intersect_byte_simple((origin + direction * distance) * 2.f - normal * epsilon, direction, (index & brick_lod_bits) >> 12)) {
//					return true;
//				}
//			} else {
//				if (index & brick_loaded_bit) {
//					float sub_distance = 0.f;
//					Brick* p = scene.bricks[supercell_index];
//					if (intersect_brick_simple((origin + direction * distance) * 8.f - normal * epsilon, direction, &p[index & brick_index_bits])) {
//						return true;
//					}
//				} else if (index & brick_unloaded_bit) {
//					uint32_t old = atomicOr(&index, brick_requested_bit);
